...
# 새 워드 문서 만들기 
# doc = Document()
doc = Document('C:\PYTHONWORKSPACE\\TP8_YR.docx')
...
doc.save('C:\\PYTHONWORKSPACE\\webscraping_basic\\webscraping_project\\2022\\Y&R_리포트_{}.docx'.format(today_time))


################################ 목차 업데이트 ####################################### 
word = win32com.client.DispatchEx("Word.Application")
doc = word.Documents.Open('C:\\PYTHONWORKSPACE\\webscraping_basic\\webscraping_project\\2022\\Y&R_리포트_{}.docx'.format(today_time))
