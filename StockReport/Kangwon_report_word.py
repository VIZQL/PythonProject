...
# 새 워드 문서 만들기 
# doc = Document()
doc = Document('C:\PYTHONWORKSPACE\\TP4.docx')
...
doc.add_heading('4. 그 외 특징주 정리 : ', level = 1)
...
try:
    Kangwon_stocks_info.main_announce_AftMarket()
except:
    pass
...
p.add_run(": 최근 의미있는 상승을 보여준뒤 해당 이평선에 근접한 끼 있는 종목")
p.runs[0].font.size = Pt(10)
...
doc = word.Documents.Open('C:\\PYTHONWORKSPACE\\webscraping_basic\\webscraping_project\\2022\\kikawo_SD_리포트_{}.docx'.format(today_time))
